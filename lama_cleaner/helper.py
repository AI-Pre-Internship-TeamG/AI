...
from lama_cleaner.model.s3Config import AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
...
def get_image(filename):
    ...
    bucket = s3.Bucket('team-g-bucket')
    file_stream = bucket.Object(filename).get()['Body'].read()
    return file_stream
